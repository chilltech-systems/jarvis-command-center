...
export const JARVIS_INTEGRATIONS: JarvisIntegration[] = [
  ...
  { key: "codex", name: "Codex", category: "Development", status: "Connected", permission: "draft", credentialEnvironmentKeys: [], capabilities: ["Create task briefs", "Architecture context", "Future local runner handoff"], notes: "Jarvis prepares structured Codex prompt packages. Direct execution needs a local runner or Codex connector." },
