...
export const JARVIS_INTEGRATIONS: JarvisIntegration[] = [
  ...
  { key: "openai", name: "OpenAI", category: "Intelligence", status: "Ready To Configure", permission: "execute", credentialEnvironmentKeys: ["OPENAI_API_KEY"], capabilities: ["Assistant reasoning", "Tool selection", "Summarization"], notes: "Add a server-side credential before enabling model responses." },
