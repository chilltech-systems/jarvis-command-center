...
export const JARVIS_INTEGRATIONS: JarvisIntegration[] = [
  ...
  { key: "openai", name: "OpenAI", category: "Intelligence", status: "Ready To Configure", permission: "execute", credentialEnvironmentKeys: ["OPENAI_API_KEY"], capabilities: ["Assistant reasoning", "Tool-aware responses", "Summarization"], notes: "Uses the server-side Responses API while Jarvis retains deterministic permission and approval enforcement." },
  ...
  { key: "codex", name: "Codex", category: "Development", status: "Ready To Configure", permission: "draft", credentialEnvironmentKeys: [], capabilities: ["Create task briefs", "Architecture context", "Future task handoff"], notes: "Phase 1 prepares structured Codex task drafts." },
