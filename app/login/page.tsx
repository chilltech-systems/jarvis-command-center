  ...
  return (
    <main className="login-wrap">
      <section className="login-card">
        ...
        <p className="subtle">Sign in with an approved Google account so I can bring your private telemetry into view.</p>
        <button type="button" onClick={login} disabled={loading} style={{ marginTop: 12 }}>
          {loading ? "CONNECTING TO GOOGLE..." : "SIGN IN WITH GOOGLE"}
        </button>
        <p className="login-hint">I will ask which Google account to use on every new sign-in.</p>
